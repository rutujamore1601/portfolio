        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Rutuja More</span>, a Software Developer specializing in secure, scalable full-stack applications built with Node.js, PHP, and RESTful APIs. From backend architecture to cloud deployment, I focus on clean engineering and delivering high-quality software that protects data and performs reliably in production.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-medium tracking-[0.22em] uppercase text-[#A8988B] mt-0.5">
                  Cloud Platforms (GCP, DigitalOcean, GoDaddy)
                </span>
              </div>
