...
const projects: Project[] = [
  {
    number: '01',
    title: 'Curiotory',
    category: 'EDTECH / LANGUAGE LEARNING PLATFORM',
    description:
      'Online language-learning platform managing educational content and resources across multiple languages, including MCQ tests and video lessons. Built RESTful APIs and backend architecture to collect and process learning data, deployed on cloud servers.',
    githubUrl: '#',
    tech: ['CodeIgniter', 'PHP', 'MySQL', 'Ionic', 'AngularJS', 'REST APIs'],
    metrics: [
      { label: 'PLATFORM', value: 'Web & Mobile (Ionic)' },
      { label: 'CONTENT', value: 'MCQ Tests + Video' },
  ...
  },
  {
    ...
    description:
      'AI-driven interview platform that parses a candidate\'s resume and automatically generates interview questions based on the skills and projects it identifies. Handles user login, backend data processing, and cloud deployment.',
    githubUrl: '#',
    tech: ['Node.js', 'MongoDB', 'Ionic', 'AngularJS', 'Python', 'REST APIs'],
    metrics: [
      { label: 'ENGINE', value: 'AI Resume Parsing' },
      { label: 'OUTPUT', value: 'Auto-Generated Questions' },
  ...
  },
  {
    ...
    description:
      'Online learning and examination platform managing MCQ tests and course documents. Based on test results, generates a personalized Individual Development Plan (IDP) as a downloadable PDF.',
    githubUrl: '#',
    tech: ['Laravel', 'PHP', 'MySQL', 'HTML', 'CSS', 'Bootstrap'],
    metrics: [
      { label: 'OUTPUT', value: 'Personalized IDP (PDF)' },
      { label: 'ASSESSMENT', value: 'MCQ Engine' },
      { label: 'STATUS', value: 'Live' },
    ],
  },
  {
    number: '04',
    title: 'Hardev',
    category: 'HEALTHTECH / REPORTING SYSTEM',
    description:
      'Online medical report generation platform managing medical content and resources for multiple user types. Built RESTful APIs and backend architecture for reliable report generation and data handling.',
    githubUrl: '#',
    tech: ['CodeIgniter', 'PHP', 'MySQL', 'AngularJS', 'REST APIs'],
    metrics: [
      { label: 'DOMAIN', value: 'Medical Reporting' },
      { label: 'ARCHITECTURE', value: 'RESTful APIs' },
      { label: 'STATUS', value: 'Live' },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Scroll down to unfold each platform. Every project was built to solve a real operational or educational challenge.
          </p>
        </motion.div>
