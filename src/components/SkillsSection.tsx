...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Node.js', 'PHP', 'CodeIgniter 4', 'Laravel', 'RESTful APIs'],
    description: 'Building RESTful APIs and server-side logic across PHP and Node.js frameworks — from routing and authentication to request handling and error management.',
    stat: 'REST-FIRST',
  ...
  },
  {
    ...
    badge: 'PERSISTENCE',
    items: ['MySQL', 'MongoDB'],
    description: 'Designing and maintaining well-functioning relational and document databases, with backend architecture built to collect and process application data reliably.',
    stat: 'SQL & NOSQL',
  ...
  },
  {
    ...
    badge: 'CLIENT-SIDE',
    items: ['HTML', 'CSS', 'JavaScript', 'Bootstrap', 'AngularJS', 'Ionic'],
    description: 'Building responsive, mobile-friendly interfaces on top of AngularJS and Ionic, styled with Bootstrap and custom CSS for a clean, usable experience.',
    stat: 'RESPONSIVE',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    items: ['GCP', 'DigitalOcean', 'GoDaddy', 'GitHub', 'GitLab', 'Postman', 'Internet Security'],
    description: 'Deploying and maintaining live applications across GCP Compute Engine, DigitalOcean droplets, and GoDaddy hosting — with DNS, SSL, and security configuration handled end-to-end.',
    stat: 'MULTI-CLOUD',
    colSpan: 'lg:col-span-7',
  },
];
