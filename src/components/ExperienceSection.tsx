...
const journey: RouteStop[] = [
  {
    ...
    organization: 'IOWEB3 TECHNOLOGIES PVT LTD',
    description: 'Building and deploying full-stack platforms — RESTful APIs, backend architecture, and databases — across edtech, AI, and healthtech projects, with applications live on cloud servers.',
  },
  {
    id: '02',
    year: '2019 - 2022',
    title: 'BACHELOR OF COMPUTER SCIENCE (BCS)',
    organization: 'SADGURU GHADGE MAHARAJ COLLEGE',
    description: 'Completed a Bachelor\'s degree in Computer Science, building the technical foundation for full-stack development and secure software engineering.',
  },
];
