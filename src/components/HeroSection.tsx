          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL STACK DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> BACKEND ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> CLOUD DEPLOYMENT
              </p>
            </motion.div>
            ...
            >
              <p>
                I build secure, scalable applications with Node.js, PHP and RESTful APIs.
                <br />
                From backend architecture to cloud deployment, I turn ideas into reliable, production-ready software.
              </p>
            </motion.div>
